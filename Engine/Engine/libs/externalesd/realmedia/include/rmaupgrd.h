/****************************************************************************
 * 
 *  $Id: rmaupgrd.h,v 1.10 1999/08/17 18:04:16 rahul Exp $
 *
...
#undef  INTERFACE
#define INTERFACE   IRMASystemRequired

DECLARE_INTERFACE_(IRMASystemRequired, IUnknown)
{
    /*
     * IRMASystemRequired methods
     */

    /************************************************************************
     *	Method:
     *		IRMASystemRequired::HasFeatures
     *	Purpose:
     *		Check if required features are present on the system.
     *  Returns:
     *		PNR_OK -    features are here, no upgrade required;
     *			    all features are removed from pFeatures.
     *		PNR_FAIL -  some features are missing;
     *			    pFeatures contains only those features 
     *			    that need upgrade.
     *
     */			      
    STDMETHOD(HasFeatures)  (THIS_ 
			    IRMAUpgradeCollection* pFeatures) PURE;
};
