...
//Uncomment this if you want the music completely loaded so that there is no file access while
//playing
//#define LTDM_BUFFER_MUSIC_FILES
...
private:
	...
	public:
		...
		const uint8*	GetFileData() const		{ return m_pFileData; }
	...
	private:
		...
		//the reference count of this buffer
		LONG		m_nRefCount;
	...
	//our file buffer
	CFileBuffer*	m_pBuffer;

	//the filepointer inside of the file
