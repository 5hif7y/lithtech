...
public:
	...
	// Pick default device from our list...
	D3DDeviceInfo*			PickDefaultDev(D3DAdapterInfo** pAdapterInfo);					

	// Pick default mode from the passed devices mode list...
	D3DModeInfo*			PickDefaultMode(D3DDeviceInfo* pDeviceInfo, uint32 nWidth, uint32 nHeight, uint32 iBitDepth, bool bHWTnL);	
	...
	void					GetSupportedModes(RMode*& pGlobalModeList); // List out the modes for the game...
