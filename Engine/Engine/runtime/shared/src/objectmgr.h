...
#define TRACKER_CACHE           16
#define TRACKER_START_SIZE      32
...
inline bool HasWorldModel(LTObject *pObject)      {return pObject->HasWorldModel();}
inline bool IsModel(LTObject *pObject)      {return pObject->IsModel();}
...
inline LTVolumeEffect* ToVolumeEffect(LTObject *pObject)    {return pObject->ToVolumeEffect();}
...
public:
    ...
    ObjectBank<LTVolumeEffect>          m_ObjectBankVolumeEffect;
