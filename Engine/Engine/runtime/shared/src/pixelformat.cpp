...
LTRESULT GenericCopy(FormatMgr *pFormatMgr, const FMConvertRequest *pRequest, LTRGB* pTransColor)
{
	...
	bytesPerLine = pRequest->m_Width * pRequest->m_pSrcFormat->GetBytesPerPixel();
...
LTRESULT Convert8Pto32(FormatMgr *pFormatMgr, const FMConvertRequest *pRequest, LTRGB* pTransColor)
{
	...
	{
		return Convert2Pass(pFormatMgr, pRequest, (CC_8PtoBF*)LTNULL, (CC_BFto32*)LTNULL, pTransColor);
	}
}
...
LTRESULT Convert8to8(FormatMgr *pFormatMgr, const FMConvertRequest *pRequest, LTRGB* pTransColor)
{
	...
	{
		return Convert2Pass(pFormatMgr, pRequest, (CC_8toBF*)LTNULL, (CC_BFto8*)LTNULL, pTransColor);
	}
}
...
LTRESULT Convert8to32(FormatMgr *pFormatMgr, const FMConvertRequest *pRequest, LTRGB* pTransColor)
{
	...
	{
		return Convert2Pass(pFormatMgr, pRequest, (CC_8toBF*)LTNULL, (CC_BFto32*)LTNULL, pTransColor);
	}
}
...
LTRESULT Convert16to16(FormatMgr *pFormatMgr, const FMConvertRequest *pRequest, LTRGB* pTransColor)
{
	...
	{
		return Convert2Pass(pFormatMgr, pRequest, (CC_16toBF*)LTNULL, (CC_BFto16*)LTNULL, pTransColor);
	}
}
...
LTRESULT Convert16to32(FormatMgr *pFormatMgr, const FMConvertRequest *pRequest, LTRGB* pTransColor)
{
	...
	{
		return Convert2Pass(pFormatMgr, pRequest, (CC_16toBF*)LTNULL, (CC_BFto32*)LTNULL, pTransColor);
	}
}
...
LTRESULT Convert32to8P(FormatMgr *pFormatMgr, const FMConvertRequest *pRequest, LTRGB* pTransColor)
{
	...
	{
		return Convert2Pass(pFormatMgr, pRequest, (CC_32toBF*)LTNULL, (CC_BFto8*)LTNULL, pTransColor);
	}
}
...
LTRESULT Convert32to16(FormatMgr *pFormatMgr, const FMConvertRequest *pRequest, LTRGB* pTransColor)
{
	...
	{
		return Convert2Pass(pFormatMgr, pRequest, (CC_32toBF*)LTNULL, (CC_BFto16*)LTNULL, pTransColor);
	}
}
...
LTRESULT Convert32to32(FormatMgr *pFormatMgr, const FMConvertRequest *pRequest, LTRGB* pTransColor)
{
	...
	{
		return Convert2Pass(pFormatMgr, pRequest, (CC_32toBF*)LTNULL, (CC_BFto32*)LTNULL, pTransColor);
	}
}
...
ConvertPixelsFn g_ConvertPixelsFns[NUM_BIT_TYPES][NUM_BIT_TYPES] =
{
	...
	LTNULL,			LTNULL,			Convert32Pto16,	Convert32Pto32,	LTNULL,		LTNULL,		LTNULL,			GenericCopy,	LTNULL,
	LTNULL,			LTNULL,			Convert24to16,	Convert24to32,	LTNULL,		LTNULL,		LTNULL,			LTNULL,			GenericCopy
};

// Base-format to any.
ConvertPValueFn g_ConvertFromPValueFns[NUM_BIT_TYPES] =
{
	LTNULL, CPV_BFto8, CPV_BFto16, CPV_BFto32, LTNULL, LTNULL, LTNULL, LTNULL, LTNULL
};

ConvertPValueFn g_ConvertToPValueFns[NUM_BIT_TYPES] =
{
	LTNULL, CPV_8toBF, CPV_16toBF, CPV_32toBF, LTNULL, LTNULL, LTNULL, LTNULL, LTNULL
};
...
LTRESULT FormatMgr::ConvertPixels(const FMConvertRequest *pRequest, LTRGB* pTransColor)
{
	...
	return fn(this, pRequest, pTransColor);
}
...
LTRESULT FormatMgr::FillRect(FMRectRequest *pRequest)
{
	...
	pOutLine += pRequest->m_Rect.left * pRequest->m_pDestFormat->GetBytesPerPixel();
