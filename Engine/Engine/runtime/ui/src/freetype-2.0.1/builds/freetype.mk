...
# this is the easiest way to build all components
# include $(wildcard $(SRC)/*/rules.mk)

# or build it piecemeal to save code size
include $(SRC)/base/rules.mk
include $(SRC)/psnames/rules.mk
include $(SRC)/sfnt/rules.mk
include $(SRC)/smooth/rules.mk
include $(SRC)/truetype/rules.mk

#include $(SRC)/autohint/rules.mk
#include $(SRC)/cache/rules.mk
#include $(SRC)/cff/rules.mk
#include $(SRC)/cid/rules.mk
#include $(SRC)/psaux/rules.mk
#include $(SRC)/raster/rules.mk
#include $(SRC)/type1/rules.mk
#include $(SRC)/winfonts/rules.mk
