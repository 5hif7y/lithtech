...
#define FT_CONFIG_ROOT  FT_ROOT/config
  ...
  /* given header file.                                                    */
  /*                                                                       */
#define FT_PUBLIC_FILE(x)  <freetype/x> /*<(FT_ROOT)/x>*/
  ...
  /*                                                                       */
#define FT_CONFIG_FILE( x )  <freetype/config/x> /*<FT_CONFIG_ROOT/x>*/
  ...
  /*                                                                       */
#define FT_INTERNAL_FILE( x )  <freetype/internal/x> /*<FT_ROOT/internal/x>*/
  ...
  /* FT_FLAT_COMPILATION.                                                  */
  /*                                                                       */
#define FT_COMPONENT_FILE( d, x )  <freetype/d/x> /*<FT_ROOT/d/x>*/
