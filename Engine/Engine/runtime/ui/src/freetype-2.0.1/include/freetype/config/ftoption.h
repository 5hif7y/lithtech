...
#define FTOPTION_H
  ...
  /* Conditional compile                                                   */
  /*                                                                       */
  /*   Enable/Disable the whole freetype ball-o'-wax by commenting         */
  /*   this in or out.  If your build of the LithTech engine does not      */
  /*   require TrueType font support, you can save about 90 Kb by not      */
  /*   compiling Freetype.                                                 */
  /*                                                                       */
#define FT_ENABLE_FREETYPE 
...
#define FT_CONFIG_OPTION_OLD_CALCS
  ...
  /*                                                                       */
#define FT_RENDER_POOL_SIZE  5120
