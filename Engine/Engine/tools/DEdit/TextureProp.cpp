// TextureProp.cpp : implementation file
//
...
CTextureProp *g_pTexturePropDlg=NULL;
...
CTextureProp::CTextureProp(CWnd* pParent /*=NULL*/)
	: CDialog(CTextureProp::IDD, pParent)
{
	//{{AFX_DATA_INIT(CTextureProp)
	//}}AFX_DATA_INIT
	m_ChangeFlags = 0;
...
void CTextureProp::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CTextureProp)
...
BEGIN_MESSAGE_MAP(CTextureProp, CDialog)
	//{{AFX_MSG_MAP(CTextureProp)
...
void CTextureProp::SetCheckBox(UINT id, BOOL bCheck)
{
	CButton *pButton;
...
void CTextureProp::EnableCheckBox(UINT id, BOOL bEnable)
{
	CButton *pButton;
...
BOOL CTextureProp::GetCheckBox(UINT id)
{
	CButton *pButton;
...
void CTextureProp::SetupBPPIdent()
{
...
void CTextureProp::RedrawPreviewWindow()
{
	if(m_hPreviewWnd)
	{
...
void CTextureProp::SetChange(DWORD id, DWORD flag)
{
	CWnd *pWnd;
...
void CTextureProp::OnPrefer5551() 
{
	if(m_bTFormatChanges)
	{
		SetChange(IDC_PREFER5551, TPROP_PREFER5551);
...
void CTextureProp::OnPrefer16Bit()
{
	SetChange(IDC_PREFER16BIT, TPROP_PREFER16BIT);
}

void CTextureProp::OnNoSysCache()
{
	SetChange(IDC_NOSYSCACHE, TPROP_NOSYSCACHE);
}

void CTextureProp::OnChangeDtxCommandString() 
{
...
void CTextureProp::OnFormatDxt1() 
{
	SetChange(IDC_DATAFORMAT, TPROP_DATAFORMAT);
...
void CTextureProp::OnFormatDxt3() 
{
	SetChange(IDC_DATAFORMAT, TPROP_DATAFORMAT);
...
void CTextureProp::OnFormatDxt5() 
{
	SetChange(IDC_DATAFORMAT, TPROP_DATAFORMAT);
