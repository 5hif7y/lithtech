...
enum ERenStyle_ClipMode {
	RENDERSTYLE_NOCLIP,
	RENDERSTYLE_FASTCLIP,
	RENDERSTYLE_FULLCLIP };
...
struct TextureStageOps {					// Each Render Pass has a set of ops it'll do to apply the texture - this struct defines them.
...
public:
	...
	// RenderStates...
	virtual void					SetClipMode(ERenStyle_ClipMode eMode)					= 0;
	virtual ERenStyle_ClipMode		GetClipMode()											= 0;
	// Lighting Material...
