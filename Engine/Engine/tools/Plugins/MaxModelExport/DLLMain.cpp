...
#elif defined(USES_MAX7_SDK)
#	if MAX_API_NUM != 13
#		error Wrong MAX SDK version found, check to see if the 7.0 SDK is installed correctly.
#	endif
#elif defined(USES_MAX6_SDK)
#	if MAX_API_NUM != 13
#		error Wrong MAX SDK version found, check to see if the 6.0 SDK is installed correctly.
#	endif
#elif defined(USES_MAX5_SDK)
#	if MAX_API_NUM != 8
#		error Wrong MAX SDK version found, check to see if the 5.0 SDK is installed correctly.
#	endif
