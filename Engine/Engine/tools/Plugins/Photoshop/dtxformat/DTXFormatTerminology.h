...
#ifndef __DTXFormatTerminology_H__	// Has this not been defined yet?
#define __DTXFormatTerminology_H__	// Only include this once by predefining it

//-------------------------------------------------------------------------------
//	Definitions -- Scripting keys
//-------------------------------------------------------------------------------

#define keyMyFoo		'fooB'
#define keyMyBar		'barF'
...
#endif // __SimpleFormatTerminology_H__
