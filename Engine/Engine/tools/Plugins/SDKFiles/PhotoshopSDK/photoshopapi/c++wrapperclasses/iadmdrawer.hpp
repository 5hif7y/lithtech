...
public:	
	...
	void DrawAGMImage(AGMImageRecord* image, ASFixedMatrix* matrix, long flags);
...
inline void IADMDrawer::DrawAGMImage(AGMImageRecord* image, ASFixedMatrix* matrix, long flags)
{
