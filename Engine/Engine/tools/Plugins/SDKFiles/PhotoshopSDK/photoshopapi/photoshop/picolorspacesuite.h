 ...
 */
// $Id: //photoshop/8.0/photoshop/sharedinterfaces/PIColorSpaceSuite.h#1 $ 
...
typedef SPAPI SPErr (*ColorSpace_ConvertToMonitorRGB)(short inputCSpace,
											Color8 *input_data,
										  	Color8 *output_data,
										   	short count);
...
typedef struct 
{
	...
	ColorSpace_ConvertToMonitorRGB	ConvertToMonitorRGB;
