...
//
//-------------------------------------------------------------------------------
// $Id: //photoshop/8.0/photoshop/sharedinterfaces/PITerminology.h#2 $ 
// $DateTime: 2003/07/20 14:06:31 $ 
// $Change: 76284 $ 
// $Author: williams $ 
...
// qLimiting these is problematic. Plug-ins (which also include this file) will not necessarily have q anything defined, moreover,
// the Mac resource compiler will flag these as an error if they were never defined. -mleavy
//#if qElements
...
#define keyPrintSettings					'PMps'	// Carbon PrintManager PrintSettings.
