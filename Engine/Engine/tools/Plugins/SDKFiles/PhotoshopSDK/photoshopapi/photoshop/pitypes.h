...
// (c) Copyright  1993 - 2002 Adobe Systems Incorporated
// All Rights Reserved
//
...
//		PITypes.h
//
//	(c) Copyright 1991-2000, Adobe Systems Incorporated.
//	All Rights Reserved.
//
//	Distribution:
//		PUBLIC
...
//		
//-------------------------------------------------------------------------------
// $Id: //photoshop/8.0/photoshop/sharedinterfaces/PITypes.h#3 $ 
// $DateTime: 2003/09/03 21:06:53 $ 
// $Change: 80539 $ 
// $Author: ccox $ 
...
#if Macintosh && TARGET_CPU_68K

#define nativeFloat extended

#else

#define nativeFloat double
...
typedef struct
	{
	short vRefNum;
	short padding;	// Make the padding explicit.
	long parID;
