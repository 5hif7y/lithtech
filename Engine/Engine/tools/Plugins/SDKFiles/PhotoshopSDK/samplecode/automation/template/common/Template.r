...
#define plugInName			"Template"
#define plugInCopyrightYear	"1998"
#define plugInDescription \
	"An Actions Module sample template for Adobe Photoshop¨."
...
resource 'PiPL' ( 16000, "Template", purgeable)
	{
		{
		Kind { Actions },//"Actions" for automation plug-ins
		Name { "Template" },//name of your plug-in
