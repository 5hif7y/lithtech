...
CMFCPlugInApp::CMFCPlugInApp() : m_Value(12), m_pFilterRecord(NULL), m_pLongData(NULL)
{
...
void CMFCPlugInApp::Entry(FilterRecord* pFilterRecord, long* pData)
{
...
DLLExport SPAPI void PluginMain(const short selector,
