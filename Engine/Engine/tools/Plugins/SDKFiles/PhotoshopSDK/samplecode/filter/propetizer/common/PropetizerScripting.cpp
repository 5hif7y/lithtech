...
//-------------------------------------------------------------------------------
//
//	PropetizerPlugin::ReadScriptParameters
//
//	Set up the filter based on the descriptor passed in.
//
//-------------------------------------------------------------------------------
bool PropetizerPlugin::ReadScriptParameters(void)
{
	bool popDialog = true;
		...
		filterRecord->descriptorParameters->descriptor != NULL)
	{
		...
		if (!error && hasKey)
			sPSActionDescriptor->GetFloat(actionDescriptor, keyMyGridMinor, &fGridMinor);
...
//-------------------------------------------------------------------------------
//
//	PropetizerPlugin::WriteScriptParameters
//
//	Write out what happened.
//
//-------------------------------------------------------------------------------
void PropetizerPlugin::WriteScriptParameters(void)
{
	if (filterRecord->descriptorParameters != NULL)
	{
		...
		if (filterRecord->descriptorParameters->descriptor != NULL)
		{
			sPSHandle->Dispose(filterRecord->descriptorParameters->descriptor);
			filterRecord->descriptorParameters->descriptor = NULL;
		}
		...
		filterRecord->descriptorParameters->recordInfo = plugInDialogOptional;
	}
}
