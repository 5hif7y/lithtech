...
#ifndef __IdleTerminology_H__	// Has this not been defined yet?
#define __IdleTerminology_H__	// Only include this once by predefining it

//-------------------------------------------------------------------------------
//	Definitions -- Scripting keys
//-------------------------------------------------------------------------------

#define keyUseProgress	'proG'
#define keyIdleAmount	'idlA'
#define keySendUpdates	'sndU'

//-------------------------------------------------------------------------------

#endif // __IdleTerminology_H__
