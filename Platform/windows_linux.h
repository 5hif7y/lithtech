#pragma once
// Linux-only Win32 API shims (moved from windows.h dispatcher).
// Included by Platform/windows.h on non-Windows builds via same-dir
// quoted include (order-independent). Never include directly on _WIN32.
#include "platform.h"
#ifndef _WIN32
#include <cstdint>
#include <cstdlib>
