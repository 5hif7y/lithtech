...
ILTTextureString* g_pLTCTextureString = NULL; // wchar font support 
...
define_holder(ILTTextureString, g_pLTCTextureString); // wchar font support
...
LTRESULT VerifyClientInterfaces()
{
	...
	// wchar font support interface
	result = VerifyInterface(g_pLTCTextureString, "ILTTextureString");
	if (LT_OK != result)
		return result;
