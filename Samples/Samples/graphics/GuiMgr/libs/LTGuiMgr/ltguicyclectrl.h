...
public:
    ...
    LTBOOL           Create ( const wchar_t *pText, uint32 nHelpID, CFontInfo *pFont, uint8 nFontSize,
   ...
   virtual void    UpdateData(LTBOOL bSaveAndValidate);
	...
	CLTGUIPolyString*	GetString(uint8 nIndex);			// Return a string at a specific index
...
protected:
   ...
   uint16		m_nHeight;             // The height of the control
	...
	CLTGUIPolyString*		m_pHeaderText;
