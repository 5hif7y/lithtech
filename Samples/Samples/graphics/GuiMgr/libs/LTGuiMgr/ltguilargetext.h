...
public:
   ...
   LTBOOL Create ( const wchar_t *pText, CFontInfo *pFont, uint8 nFontSize, LTIntPt ptTextSize );
   ...
   virtual void   SetBasePos ( LTIntPt pos );
	...
	LTBOOL	UseArrows(LTFLOAT fTextureScale, HTEXTURE hUpNormal,  HTEXTURE hUpSelected, HTEXTURE hDownNormal,  HTEXTURE hDownSelected);
