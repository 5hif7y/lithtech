...
//slider texture highlight layout is the same as above.
...
public:
    ...
    LTBOOL	Create (  const wchar_t *pText, uint32 dwHelpID, CFontInfo *pFont, uint8 nFontSize, HTEXTURE hBarTexture, 
   ...
   virtual LTBOOL	SetFont ( CFontInfo *pFont, uint8 nFontSize);
	...
	void SetHighlightTexture ( HTEXTURE hTexture );
