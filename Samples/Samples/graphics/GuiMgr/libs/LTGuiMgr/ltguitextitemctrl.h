...
public:
	...
	LTBOOL           Create (	const wchar_t *pText, uint32 nCommandID, uint32 nHelpID, 
								CFontInfo *pFont, uint8 nFontSize, CLTGUICommandHandler *pCommandHandler, 
	...
	virtual void		SetString(const wchar_t *pText);
	CLTGUIPolyString*	GetString()  {return m_pString;}
