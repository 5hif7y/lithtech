...
BEGIN_CLASS(PolyGrid)
    ...
    ADD_STRINGPROP_FLAG(SpriteSurfaceName, "", PF_FILENAME)
...
END_CLASS_DEFAULT(PolyGrid, GameBase, NULL, NULL)
...
void PolyGrid::Setup()
{
	...
	g_pLTSPhysics->SetObjectDims(m_hObject, &m_vDims, 0);
...
void PolyGrid::ReadProp(ObjectCreateStruct * pStruct)
{
	...
	pServerDE->GetPropLongInt("EffectID", (int32*)&m_nEffectID);
