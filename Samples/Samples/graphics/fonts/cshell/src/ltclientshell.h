...
private:
	...
	// Gui objects used to display text
	CGui            	m_GuiTTF;	//Created using a true type font (.ttf file)
	CGui            	m_GuiMBMP;	//Created using a bitmap (monospace)
	CGui					m_GuiPBMP;	//Created using a bitmap (proportional)
	CGuiWide				m_GuiWide;	//Created using true type font wchar support
